...
*/
        ...
        String screenshotpath = takescreenshot.ScreenShot(ele, RbLOccluderchecked);

        BaseCompareImages action = new BaseCompareImages();

        action.setThreshold("15");
        File Resourcesdirectory = new File("src/main/Resources/RBLchecked.png");
        File Screenshotdirectory = new File("src/main/Resources/Screenshots/RBLchecked.png");
        executionResult = action.compareImagesUtils(Resourcesdirectory,Screenshotdirectory,report);

        BooleanCheck.ReporterCheck(report, executionResult ==ExecutionResult.PASSED, "RBL checked  image compare result");
