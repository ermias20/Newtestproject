package SettingsTests.Refraction.Rounding;
...
@Test(name = "EighthRounding", version = "1.0")

public class EighthRounding implements AndroidTest {
    ...
    public ExecutionResult execute(AndroidTestHelper helper) throws FailureException {
        ...
        BooleanCheck.ReporterCheck(report,RefractionTab.Eighth() , "0.125 sphere rounding chosen");
       ...
       ExamFileMeasureData initexamfile = new ExamFileMeasureData(helper);
        ...
        BooleanCheck.ReporterCheck(report, checkWf.check(ExamFileWFRightsphere,0.125), "Exam file Right wf Sphere 0.125 rounding check");
        BooleanCheck.ReporterCheck(report, checkWf.check(ExamFileWFlefttsphere,0.125), "Exam file Left wf Sphere 0.125 rounding check");
        BooleanCheck.ReporterCheck(report, checkWf.check(ExamFileFinalRightsphere,0.125), "Exam file Right final Sphere 0.125 rounding check");
        BooleanCheck.ReporterCheck(report,  checkWf.check(ExamFileFinalLeftsphere,0.125), "Exam file Left final Sphere 0.125 rounding check");
        ...
        BooleanCheck.ReporterCheck(report, checkFinal.check(ReportWFRightsphere,0.125), "Report page Right wf Sphere 0.125 rounding check");
        BooleanCheck.ReporterCheck(report, checkFinal.check(ReporWFLeftsphere,0.125), "Report page Right wf Sphere 0.125 rounding check");
        BooleanCheck.ReporterCheck(report,  checkFinal.check(ReportFinalRightsphere,0.125), "Report page Right wf Sphere 0.125 rounding check");
        BooleanCheck.ReporterCheck(report,  checkFinal.check(ReportFinalLeftsphere,0.125), "Report page Right wf Sphere 0.125 rounding check");
