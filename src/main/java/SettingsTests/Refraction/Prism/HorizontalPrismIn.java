...
public class HorizontalPrismIn implements AndroidTest {
    ...
    String XpathaccHorizontal = "//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/androidx.drawerlayout.widget.DrawerLayout[1]/androidx.drawerlayout.widget.DrawerLayout[1]/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[2]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[1]/android.widget.ImageView[3]";
        ...
        BooleanCheck.ReporterCheck(report, newSettings.OpenSettings(), "open settings ");
            ...
            BooleanCheck.ReporterCheck(report, seekbar.dragSeekBarTo(HorizontalPrismInval,seekbar.hprismseekBar,seekbar.hstep), "Horizontal In prism  value is " + HorizontalPrismInval);

            BooleanCheck.ReporterCheck(report, RefractionTab.HorizontalIn(), "Horizontal In prism  chosen");
        ...
        File Resourcesdirectory = new File("src/main/Resources/HorizontalPrismIn.png");
        File Screenshotdirectory = new File("src/main/Resources/Screenshots/HorizontalPrismIn.png");
        executionResult = action.compareImagesUtils(Resourcesdirectory,Screenshotdirectory,report);


            BooleanCheck.ReporterCheck(report, executionResult ==ExecutionResult.PASSED, "accesseories image compare result");
            ...
            BooleanCheck.ReporterCheck(report, NewCurrentprismvalue==Currentprismvalue, "prism y value");
