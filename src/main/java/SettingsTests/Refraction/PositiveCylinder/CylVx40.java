...
@Test(name = "cyl+ vx40", version = "1.0")

public class CylVx40 implements AndroidTest {
    @Parameter(defaultValue = "", direction = ParameterDirection.INPUT)
    public String XmlCompany;
    @Parameter(defaultValue = "", direction = ParameterDirection.INPUT)
    ...
    public String XmlTr;
    @Parameter(defaultValue = "", direction = ParameterDirection.INPUT)
    public String XmlFirstName;
    @Parameter(defaultValue = "", direction = ParameterDirection.INPUT)
    public String XmlMiddleName;
    @Parameter(defaultValue = "", direction = ParameterDirection.INPUT)
    public String XmlLastName;
    @Parameter(defaultValue = "", direction = ParameterDirection.INPUT)
    ...
    public ExecutionResult execute(AndroidTestHelper helper) throws FailureException {
        ...
        By by;
       /* CreateXml newDatain= new CreateXml();

        newDatain.Company =XmlCompany;
        newDatain.Date =XmlDate;
        newDatain.Time=XmlTime;
        newDatain.ID=XmlID;
        newDatain.Tr=XmlTr;
        newDatain.FirstName=XmlFirstName;
        newDatain.MiddleName=XmlMiddleName;
        newDatain.LastName=XmlLastName;
        newDatain.Gender=XmlGender;
        newDatain.Birthday=XmlBirthday;
        newDatain.writexml(Xmlpath);
*/
