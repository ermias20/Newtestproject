...
public class RefractionSettings {
    ...
    public boolean SelectCylplus() {
        test.clickIfVisible(ChangeCylSign);
        return test.clickIfVisible(Cylplus);
    }  public boolean SelectCylMinus() {
        test.clickIfVisible(ChangeCylSign);
        return test.clickIfVisible(CylMinus);
    }
