...
public class ManualLM {
	...
	public By RightCyl = By.id("current_cylinder_right_value");
	public By LeftCyl = By.id("current_cylinder_left_value");
	public By Rightaxis = By.id("current_axis_right_value");
	public By Leftaxis = By.id("current_axis_left_value");

	public ManualLM(AndroidTestHelper helper) {
